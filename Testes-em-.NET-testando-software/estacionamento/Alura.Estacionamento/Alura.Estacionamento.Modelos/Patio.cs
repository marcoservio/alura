...
namespace Alura.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        private Operador _operadorPartio;
        public double Faturado { get => faturado; set => faturado = value; }
        public List<Veiculo> Veiculos { get => veiculos; set => veiculos = value; }
        public Operador OperadorPartio { get => _operadorPartio; set => _operadorPartio = value; }
        ...
        {
            var veiculoTmp = (from veiculo in this.Veiculos
        ...
        private string GerarTicket(Veiculo veiculo)
        {
            ...
            string ticket = $"### Ticket Estacionamento Alura ###" +
                            ...
                            $">>> Operador Patio: {OperadorPartio.Nome}";
