...
INSERT INTO TST_BACKUP (POS) VALUES (1)
BACKUP DATABASE SUCOS_VENDAS TO DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH INIT 

-- 4:00 AM - BACKUP LOG
INSERT INTO TST_BACKUP (POS) VALUES (2)
BACKUP LOG SUCOS_VENDAS TO DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH NOINIT
...
BACKUP DATABASE SUCOS_VENDAS TO DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH DIFFERENTIAL
...
RESTORE HEADERONLY FROM DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK'
...
-- 1:00 AM - BACKUP FULL INICIAL (1)
RESTORE DATABASE SUCOS_VENDAS FROM DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH FILE = 1, NORECOVERY

-- 14:00 PM - BACKUP DIFERENCIAL (9)
RESTORE DATABASE SUCOS_VENDAS FROM DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH FILE = 9, NORECOVERY

-- 15:00 PM - BACKUP LOG (10)
RESTORE LOG SUCOS_VENDAS FROM DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH FILE = 10, NORECOVERY

-- 17:00 PM - BACKUP LOG (11)
RESTORE LOG SUCOS_VENDAS FROM DISK = 'C:\temp\sql\SUCOS_VENDAS_COMPLETO.BAK' WITH FILE = 11, RECOVERY